# 段1 合成→実装→ビットストリーム生成
open_project /mnt/data/fpga/projects/kv260_audio/i2s2/vivado/i2s2_tone.xpr
...
open_run impl_1
report_utilization -file $bitdir/util_seg1.rpt
report_timing_summary -file $bitdir/timing_seg1.rpt
