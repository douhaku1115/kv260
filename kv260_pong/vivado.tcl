...
set rtl_files {rtl/rtl_top.v rtl/cdc_synchronizer.v rtl/shift_register.v rtl/vga_iface.v rtl/rect_axi_slave.v}
...
set axi_slave_name rect_axi_slave
...
# ============================================================
# PS config — M_AXI_GP0 を有効化、DP Live Video 入力使用
# ============================================================
...
# ============================================================
# Clock wizard (pl_clk0 → AXI 用クロック)
# ============================================================
...
# ============================================================
# RTL modules (rtl_top + rect_axi_slave)
# ============================================================
...
# ============================================================
# AXI Interconnect (PS M_AXI_HPM0_FPD → rect_axi_slave)
# ============================================================
...
# ビデオクロック (DP video ref clk → rtl_top.clkv)
...
# ============================================================
# PS AXI マスタ → Interconnect → rect_axi_slave
# ============================================================
...
# ============================================================
# rect_axi_slave 出力 → rtl_top 入力 (3 オブジェクト分)
# ============================================================
connect_bd_net [get_bd_pins ${axi_slave_instance}/padl_x] [get_bd_pins ${rtl_top_instance}/padl_x_axi]
connect_bd_net [get_bd_pins ${axi_slave_instance}/padl_y] [get_bd_pins ${rtl_top_instance}/padl_y_axi]
connect_bd_net [get_bd_pins ${axi_slave_instance}/padr_x] [get_bd_pins ${rtl_top_instance}/padr_x_axi]
connect_bd_net [get_bd_pins ${axi_slave_instance}/padr_y] [get_bd_pins ${rtl_top_instance}/padr_y_axi]
connect_bd_net [get_bd_pins ${axi_slave_instance}/ball_x] [get_bd_pins ${rtl_top_instance}/ball_x_axi]
connect_bd_net [get_bd_pins ${axi_slave_instance}/ball_y] [get_bd_pins ${rtl_top_instance}/ball_y_axi]

# ============================================================
# アドレス割当: 0xA0000000 (4KB)
# ============================================================
...
write_hw_platform -fixed -force -include_bit E:/fpga/kria260/kv260_pong/project_1/design_1_wrapper.xsa
exit
