# ============================================================
# RISC-V on KV260 - 第3段 完全RV32I + CSR/例外 + gccフロー VIO project
...
set project_name "riscv_kv260_rvsys"
...
add_files -norecurse ${src_dir}/main_vio_rv32i_csr.v
...
puts "BIT: $bit"
puts "LTX: $ltx"
puts "BUILD OK (rvsys: full RV32I + CSR/exception + gcc flow -> VIO)"
