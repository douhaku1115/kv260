// ============================================================
// RISC-V on KV260 - 5段パイプライン版 (教科書 m_proc9 / code6-27)
//   (ファイル名は4stageだが教科書の数え方で m_proc9 は5段=IF/ID/EX/MEM/WB)
//   前回の4段(m_proc8_F, MEMをEXに併合)の枠組みを流用。
//   m_proc9 に結果出力 r_dout を追加:
//     プログラム末尾 HALT(addi x30,x10,0) で合計がx30に入る。
//     5段なのでライトバックはP4段 → P4でx30書込時に w_rt を capture。
