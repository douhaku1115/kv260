# ============================================================
# RISC-V on KV260 - 分岐予測版 (5段 m_proc9 + BTB + gshare) VIO project
#   命令メモリはネストループ(asm_nested.txt, 結果505)。
# Usage: vivado -mode batch -source create_gshare.tcl
# ============================================================

set project_name "riscv_kv260_gshare"
...
# 設計ファイル(gshare版) + プログラム(ネストループ)
add_files -norecurse ${src_dir}/main_vio_gshare.v
add_files -norecurse ${src_dir}/asm_nested.txt
set_property file_type "Verilog Header" [get_files asm_nested.txt]
...
puts "BIT: $bit"
puts "LTX: $ltx"
puts "BUILD OK (gshare: 5stage + BTB + gshare, nested loop)"
