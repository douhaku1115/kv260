# ============================================================
# RISC-V on KV260 - 命令キャッシュ版 (4段 m_proc8_c2 + m_cache1 + 遅延主記憶) VIO project
# Usage: vivado -mode batch -source create_cache.tcl
# ============================================================

set project_name "riscv_kv260_cache"
...
# 設計ファイル(キャッシュ版) + プログラム
add_files -norecurse ${src_dir}/main_vio_cache.v
...
puts "BIT: $bit"
puts "LTX: $ltx"
puts "BUILD OK (cache: 4stage m_proc8_c2 + m_cache1 + slow imem)"
