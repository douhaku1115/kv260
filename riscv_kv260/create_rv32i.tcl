# ============================================================
# RISC-V on KV260 - 第3段 完全RV32I + gccフロー VIO project
...
set project_name "riscv_kv260_rv32i"
...
add_files -norecurse ${src_dir}/main_vio_rv32i.v
...
puts "BIT: $bit"
puts "LTX: $ltx"
puts "BUILD OK (rv32i: full RV32I + gcc flow -> VIO)"
