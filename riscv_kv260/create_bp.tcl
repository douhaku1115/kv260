# ============================================================
# RISC-V on KV260 - 分岐予測版 (5段 m_proc9 + BTB + bimodal) VIO project
# Usage: vivado -mode batch -source create_bp.tcl
# ============================================================

set project_name "riscv_kv260_bp"
...
# 設計ファイル(分岐予測版) + プログラム
add_files -norecurse ${src_dir}/main_vio_bp.v
...
puts "BIT: $bit"
puts "LTX: $ltx"
puts "BUILD OK (bp: 5stage + BTB + bimodal)"
