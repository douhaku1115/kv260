# ============================================================
# RISC-V on KV260 - 4段パイプライン版 (m_proc9) VIO project
# Usage: vivado -mode batch -source create_4stage.tcl
# ============================================================

set project_name "riscv_kv260_4stage"
...
# 設計ファイル(4段版) + プログラム
add_files -norecurse ${src_dir}/main_vio_4stage.v
